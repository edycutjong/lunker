...
**231 tests** · built for RevenueCat Shipaton 2026 — *Keep Them Coming Back* and *Best Game*
...
| Tests | Vitest, 231 across 11 files, on Node 22 **and** 24 | hard |
...
```sh
npm install && npm test          # 231 tests
...
**231 tests**, `npm test`. The ones that matter:
