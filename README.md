...
**269 tests** · built for RevenueCat Shipaton 2026 — *Keep Them Coming Back* and *Best Game*
...
| Tests | Vitest, 269 across 13 files, on Node 22 **and** 24 | hard |
...
```sh
npm install && npm test          # 269 tests
...
**269 tests**, `npm test`. The ones that matter:
