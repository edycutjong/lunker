...
**252 tests** · built for RevenueCat Shipaton 2026 — *Keep Them Coming Back* and *Best Game*
...
| Tests | Vitest, 252 across 12 files, on Node 22 **and** 24 | hard |
...
```sh
npm install && npm test          # 252 tests
...
**252 tests**, `npm test`. The ones that matter:
