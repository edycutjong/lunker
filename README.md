...
**260 tests** · built for RevenueCat Shipaton 2026 — *Keep Them Coming Back* and *Best Game*
...
| Tests | Vitest, 260 across 13 files, on Node 22 **and** 24 | hard |
...
```sh
npm install && npm test          # 260 tests
...
**260 tests**, `npm test`. The ones that matter:
